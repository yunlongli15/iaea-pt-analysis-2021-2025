  ...
  \begin{columns}
    \begin{column}{0.33\textwidth}
      ...
      \begin{tightitemize}
        ...
        \item $\to$ 活度较高，$\gamma$能谱法成熟
      \end{tightitemize}
    \end{column}
    \begin{column}{0.67\textwidth}
      \begin{tikzpicture}
        \node[anchor=north west, inner sep=0] (fig) at (0,0)
          {\includegraphics[width=\textwidth,keepaspectratio]{../paper/figures/fig_difficulty_pass_rate_2025.pdf}};
        % Highlight top 5 water bars (ranks 1-5 out of 42, ~top 12% of figure)
        \draw[red, line width=1.8pt, rounded corners=4pt]
          ([yshift=-0.1cm]fig.north west) rectangle
          ([xshift=-0.1cm, yshift=-1.55cm]fig.north east);
        \node[red, font=\footnotesize\bfseries] at ([xshift=-2.0cm, yshift=-0.8cm]fig.north east)
          {Co, Cs, Ba, Na (水)};
      \end{tikzpicture}
    \end{column}
  \end{columns}
...
\begin{frame}{维度1：项目难度系数与通过率}
  \begin{columns}
    \begin{column}{0.33\textwidth}
      ...
      \vspace{0.3cm}
      \begin{tightitemize}
        \item \textcolor{red}{天然核素 (U同位素)}难度\textbf{最高}、通过率最低
        \item U-238, U-235 ($\alpha$/ICP-MS/$\gamma$)
        \item $\to$ 活度较低，前处理与测量难度大
      \end{tightitemize}
    \end{column}
    \begin{column}{0.67\textwidth}
      \begin{tikzpicture}
        ...
        \draw[red, line width=1.8pt, rounded corners=4pt]
          ([yshift=-2.1cm]fig.north west) rectangle
          ([xshift=-0.1cm, yshift=-0.1cm]fig.south east);
        \node[red, font=\footnotesize\bfseries] at ([xshift=-2.5cm, yshift=-2.8cm]fig.north east)
          {U-238, U-235, Ra-226};
      \end{tikzpicture}
    \end{column}
  \end{columns}
  ...
  \begin{columns}
    ...
    \begin{column}{0.67\textwidth}
      \begin{tikzpicture}
        ...
        \draw[red, line width=1.8pt, rounded corners=4pt]
          ([yshift=-1.0cm]fig.north west) rectangle
          ([xshift=-0.1cm, yshift=-1.35cm]fig.north east);
        \draw[red, line width=1.8pt, rounded corners=4pt]
          ([yshift=-2.3cm]fig.north west) rectangle
          ([xshift=-0.1cm, yshift=-0.1cm]fig.south east);
        \node[red, font=\footnotesize\bfseries] at ([xshift=-2.2cm, yshift=-1.2cm]fig.north east)
          {K-40 (植物)};
        \node[red, font=\footnotesize\bfseries] at ([xshift=-2.8cm, yshift=-2.6cm]fig.north east)
          {Ra, Pb, Bi, Cs (植物)};
      \end{tikzpicture}
    \end{column}
  \end{columns}
  ...
  \begin{columns}
    ...
    \begin{column}{0.67\textwidth}
      \begin{tikzpicture}
        ...
        \draw[red, line width=1.8pt, rounded corners=4pt]
          ([yshift=-2.1cm]fig.north west) rectangle
          ([xshift=-0.1cm, yshift=-3.1cm]fig.north east);
        \draw[red, line width=1.8pt, rounded corners=4pt]
          ([yshift=-4.4cm]fig.north west) rectangle
          ([xshift=-0.1cm, yshift=-0.1cm]fig.south east);
        \node[red, font=\footnotesize\bfseries] at ([xshift=-3.2cm, yshift=-2.6cm]fig.north east)
          {U-238, Th-234, Ra-226, Pb-214, Bi-214 (土壤)};
        \node[red, font=\footnotesize\bfseries] at ([xshift=-3.0cm, yshift=-4.8cm]fig.north east)
          {Pa-234m, U-235 (土壤)};
      \end{tikzpicture}
    \end{column}
  \end{columns}
