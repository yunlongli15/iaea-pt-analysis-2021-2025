...
def create_year_specific_plots(year_dfs):
    ...
    for df, file_count, year in year_dfs:
        ...
        title_text = f'Laboratory Participation Analysis - {year}\n{stats_text}'
        if special_info:
        ...
        # Save image
        output_file = f"{output_folder}/labcode_participation_{year}.png"
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        plt.close()
        print(f"Chart saved: {output_file}")
        
        # Save detailed data to CSV
        csv_file = f"{output_folder}/labcode_participation_{year}.csv"
...
def create_comparison_plot(year_dfs):
    ...
    ax2.set_title('Average Lab Participation by Year', fontsize=14, fontweight='bold')
    ...
    ax3.set_title('Maximum Participation by Year', fontsize=14, fontweight='bold')
    ...
    ax4.set_title('Special Laboratory Information', fontsize=14, fontweight='bold', pad=20)
    
    plt.tight_layout()
    
    # Save comparison plot
    output_folder = "labcode_analysis_charts"
    output_file = f"{output_folder}/labcode_participation_comparison.png"
    plt.savefig(output_file, dpi=300, bbox_inches='tight')
    plt.show()
    print(f"Comparison plot saved: {output_file}")
    
    # Save comparison data
    comp_csv = f"{output_folder}/labcode_participation_comparison.csv"
...
def create_special_labs_trend(year_dfs):
    ...
    ax1.set_title('Special Labs: Project Participation', fontsize=14, fontweight='bold')
    ...
    # Save trend chart
    output_folder = "labcode_analysis_charts"
    output_file = f"{output_folder}/special_labs_trend.png"
    plt.savefig(output_file, dpi=300, bbox_inches='tight')
    plt.show()
...
def main():
    ...
    """
    print("="*60)
    print("Laboratory Participation Analysis (2021-2025)")
    print("="*60)
